...
sudo apt install nano sudo apt install screen rm -rf /root/.avail/data
...
sudo apt install tmux chmod +x availscript.sh ./availscript.sh tmux attach -t avail_node_session
